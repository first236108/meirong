...
INSERT INTO `ty_item` VALUES (1,1,5,'纹眉','好吧，写描述',NULL,0,0,100.00,180.00,0.00,'\\upload\\category\\20180613\\eba9e6656747be02f0b4b03cb2a42675.png',0,0,0,1,0,0,0,12),(2,2,5,'减肥','减肥的描述还有什么好说的呢',NULL,0,1,80.00,160.00,0.00,'\\upload\\category\\20180613\\eba9e6656747be02f0b4b03cb2a42675.png',0,0,0,1,0,0,0,6),(3,1,14,'隆鼻','隆鼻是使用硅胶假体增加鼻子形体美感的最好方式',NULL,0,1,350.00,480.00,0.00,'http://oseihxzg8.bkt.clouddn.com/Fm0L1d-qf7A8GzDn3YUajOT4zdok',0,0,0,1,0,0,0,0),(4,1,5,'双眼皮','丹凤眼、双眼皮，流波利转顾盼生辉自不必说，天源专业美容医师采用韩国纯进口无痛微创双眼皮医疗美容设备，配合顶级恢复神水为您塑造独一无二的美丽。。','',0,0,800.00,1180.00,0.00,'http://oseihxzg8.bkt.clouddn.com/FpZIazS6fnUkxe_CqP8eZOdo0ktS',0,0,0,0,0,0,0,0),(5,1,3,'七牛云存储 | 上传凭证','阿斯顿法斯蒂芬','',0,0,234.00,800.00,0.00,'http://oseihxzg8.bkt.clouddn.com/FpZIazS6fnUkxe_CqP8eZOdo0ktS',0,0,0,1,0,0,0,0),(6,1,3,'七牛云存储 | 上传凭证','asdfasdf','',0,0,234.00,800.00,0.00,'http://oseihxzg8.bkt.clouddn.com/FgcZ2oQS2yOazsqPrjxZjdkyNwq7',0,0,0,0,0,0,0,9),(7,1,5,'七牛云存储','sdfasdf','',0,0,350.00,899.00,0.00,'http://oseihxzg8.bkt.clouddn.com/For_fBnP13rPagQDIVZ7Bnyw8LS8',0,0,0,1,0,0,0,0),(8,1,3,'七牛云存储 | 上传凭证','asdf','',0,0,350.00,800.00,0.00,'http://oseihxzg8.bkt.clouddn.com/FgcZ2oQS2yOazsqPrjxZjdkyNwq7',0,0,0,1,0,0,0,0),(9,2,3,'产品详情','阿斯蒂芬asdf','<p>阿斯顿法斯蒂芬44444444444凤飞飞ffffffffffffffffffffffffffffff</p>',0,0,100.00,300.00,0.00,'http://oseihxzg8.bkt.clouddn.com/FlQwL3OhvwRcsCvv7iVTuSctgmAK',0,0,0,1,0,0,0,0),(10,1,3,'beer','asasgggg','<p>gadgdafd</p>',0,1,15.00,35.00,0.00,'http://oseihxzg8.bkt.clouddn.com/FpNkeMzRzCCd3-pAWRQieUQjfJk6',0,0,0,1,0,0,0,0);
...
INSERT INTO `ty_item_img` VALUES (3,10,'http://oseihxzg8.bkt.clouddn.com/FpNkeMzRzCCd3-pAWRQieUQjfJk6',1),(4,10,'http://oseihxzg8.bkt.clouddn.com/For_fBnP13rPagQDIVZ7Bnyw8LS8',2),(14,9,'http://oseihxzg8.bkt.clouddn.com/FlQwL3OhvwRcsCvv7iVTuSctgmAK',2);
...
CREATE TABLE `ty_order` (
  ...
  `order_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `ty_users` (
  ...
  `last_come` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `ty_users` VALUES (1,'13007686112','小志',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,1533491023,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,0,1,1533491023);
...
-- Dump completed on 2018-08-06  2:06:11
